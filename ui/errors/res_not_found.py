def resNotFound(self, app, settings, searchSettings):
    print('in res not found url')
    ...
    match searchSettings['mode']:
        ...
        case "MP4":
            self.urlEntry.insert(0, "Resolution does not exist")
